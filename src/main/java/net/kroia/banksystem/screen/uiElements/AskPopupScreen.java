...
public class AskPopupScreen extends GuiScreen {
    ...
    public static final Component TITLE = Component.translatable("gui."+BankSystemMod.MODID+".ask_popup.title");
    public static final Component YES = Component.translatable("gui."+BankSystemMod.MODID+".ask_popup.yes");
    public static final Component NO = Component.translatable("gui."+BankSystemMod.MODID+".ask_popup.no");
