...
public class BankUploadContainerMenu extends AbstractContainerMenu {
    ...
    // Server Constructor
    public BankUploadContainerMenu(int containerId, Inventory playerInv, BlockEntity blockEntity) {
        super(BankSystemMenus.BANK_UPLOAD_CONTAINER_MENU.get(), containerId);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(this.levelAccess, pPlayer, BankSystemBlocks.BANK_UPLOAD_BLOCK.get());
    }
