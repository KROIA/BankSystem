...
public class BankDownloadContainerMenu extends AbstractContainerMenu {
    ...
    // Server Constructor
    public BankDownloadContainerMenu(int containerId, Inventory playerInv, BlockEntity blockEntity) {
        super(BankSystemMenus.BANK_DOWNLOAD_CONTAINER_MENU.get(), containerId);
        ...
        createBlockEntityInventory(be.getInventory());
    }




    private void createBlockEntityInventory(Container inventory) {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(this.levelAccess, pPlayer, BankSystemBlocks.BANK_DOWNLOAD_BLOCK.get());
    }
